...
DECLARE HORIZONTAL_TARGET_SPEED TO 2245.8.
DECLARE TARGET_APO TO 100000.
DECLARE LEVEL_OFF_POINT TO 0.585.
DECLARE TARGET_ALTITUDE TO TARGET_APO * LEVEL_OFF_POINT.
DECLARE a to 0.7. // slowness of pitching start
DECLARE THROTTLE_PERSISTENCE to 2.1. // HOW MUCH THE THROTTLE WILL STAY IN HIGH VALUES BEFORE GOING TO ZERO
DECLARE THROTTLE_STOP_SMOOTHNESS to 1. // HOW SMOOTH TO END THE CURVE, THE HIGHER THE SMOOTHER
...
UNTIL APOAPSIS > 100000 {
    ...
    PRINT "LIQUID ENGINE THROTTLE: " + ROUND(LETH*100,2) + "%" AT (0,19).
}
