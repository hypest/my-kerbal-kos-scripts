...
UNTIL APOAPSIS > 100000 {
    IF SHIP:velocity:surface:mag < 100 {
        ...
        SET MYSTEER TO HEADING(90,80,270).
    ...
    //for the main loop to recognize that our apoapsis is above 100km
        ...
        SET MYSTEER TO HEADING(90,10,270).
