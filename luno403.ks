...
DECLARE THROTTLE_PERSISTENCE to 4. // HOW MUCH THE THROTTLE WILL STAY IN HIGH VALUES BEFORE GOING TO ZERO
...
LOCK LETH TO (COS(90 * (SHIP:velocity:orbit:mag/HORIZONTAL_TARGET_SPEED)^THROTTLE_PERSISTENCE))^4.
